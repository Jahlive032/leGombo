              ...
              <div className="relative z-10">
                ...
                <div className="container mx-auto px-6 py-12 flex flex-col md:flex-row items-center">
                  ...
                  <div className="md:w-1/2 mb-8 md:mb-0">
                    <h1 className="text-5xl md:text-6xl text-center md:text-left font-bold mb-6">
                  ...
                  <div className="md:w-1/2">
                    <div className="bg-[linear-gradient(to_right,#DD7DDF,#E1CD86,#BBCB92,#71C2EF,#3BFFFF,#DD7DDF,#E1CD86,#BBCB92,#71C2EF,#3BFFFF)] [background-size:200%] font-medium text-white rounded-3xl p-6 max-w-md mx-auto relative overflow-hidden card-glow">
