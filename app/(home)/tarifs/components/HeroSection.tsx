                ...
                <div className="md:flex md:flex-col justify-center items-center relative">
                    <div className="">
                        <h1 className="mb-4 text-5xl sm:text-5xl tracking-tight font-bold text-gray-900 text-center">
                            Un tarif clair et transparent, accessible à tous.
                        </h1>
                        <p className="text-center text-lg w-[75%] mx-auto mt-5">
                            Nous croyons en la simplicité et en la transparence. Notre modèle de tarification est conçu pour être facilement compréhensible et accessible à tous. Pas de frais cachés, pas de surprises – juste des prix clairs et honnêtes pour tout le monde.
                        </p>
